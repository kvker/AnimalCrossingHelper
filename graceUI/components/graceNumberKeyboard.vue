<template>
	<view>
		...
		<view class="grace-keyboard" v-if="show">
			<view class="grace-keyboard-res" v-if="showInputRes">{{resVal}}</view>
...
.grace-keyboard-done{height:340rpx !important; line-height:340rpx !important; font-size:36rpx !important; font-weight:400 !important; background:#3688FF !important; color:#FFFFFF !important;}
